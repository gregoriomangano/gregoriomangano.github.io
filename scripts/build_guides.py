...
<header class="site-header"><a class="brand" href="{root}index.html"><img src="{root}assets/branding/gregorio-profilo.jpg" alt="Gregorio Mangano"><span>Gregorio<em>Mangano</em></span></a><nav class="main-nav" aria-label="Navigazione principale"><a href="{root}index.html#chi-sono">Chi sono</a><a href="{root}index.html#servizi">Servizi</a><span class="projects-menu"><a href="{root}index.html#progetti">Progetti</a><details class="projects-dropdown"><summary aria-label="Apri elenco progetti"></summary><div><a href="{root}mg-windows-toolbox.html">M.G Windows Toolbox</a><a href="{root}mg-linux-toolbox.html">M.G Linux Toolbox</a></div></details></span><a href="{root}guide/">Guide</a><a href="{root}index.html#contatti">Contatti</a><a class="nav-donation" href="{root}donazioni.html">♡ Donazioni</a></nav><a class="button button-dark header-cta" href="{root}index.html#contatti">Parliamone ↗</a><button class="menu-toggle" type="button" aria-label="Apri menu" aria-expanded="false" aria-controls="mobile-menu">☰</button><nav id="mobile-menu" class="mobile-menu" aria-label="Menu mobile" hidden><a href="{root}index.html#chi-sono">Chi sono</a><a href="{root}index.html#servizi">Servizi</a><details><summary>Progetti</summary><a href="{root}index.html#progetti">Tutti i progetti</a><a href="{root}mg-windows-toolbox.html">M.G Windows Toolbox</a><a href="{root}mg-linux-toolbox.html">M.G Linux Toolbox</a></details><a href="{root}guide/">Guide</a><a href="{root}index.html#contatti">Contatti</a><a class="nav-donation" href="{root}donazioni.html">♡ Donazioni</a><a class="button button-dark" href="{root}index.html#contatti">Parliamone ↗</a></nav></header>'''


def page_footer() -> str:
    root = "../"
    return f'''<footer class="site-footer rich-footer"><div class="wrap footer-grid"><div class="footer-brand"><a class="brand" href="{root}index.html"><img src="{root}assets/branding/gregorio-profilo.jpg" alt="Gregorio Mangano"><span>Gregorio<em>Mangano</em></span></a><p>Tecnologia spiegata con parole chiare.</p></div><nav><b>Esplora</b><a href="{root}index.html#chi-sono">Chi sono</a><a href="{root}guide/">Guide</a><a href="{root}index.html#contatti">Contatti</a></nav><nav><b>Progetti</b><a href="{root}mg-windows-toolbox.html">M.G Windows Toolbox</a><a href="{root}mg-linux-toolbox.html">M.G Linux Toolbox</a></nav><nav><b>Seguimi</b><a href="https://www.youtube.com/@GregorioMangano" target="_blank" rel="noopener noreferrer">YouTube</a><a href="https://github.com/gregoriomangano" target="_blank" rel="noopener noreferrer">GitHub</a><a href="{root}donazioni.html">♥ Donazioni</a></nav></div><div class="wrap footer-bottom">© 2026 MANGANO GREGORIO</div></footer><script src="{root}site.js"></script></body></html>'''
...
def write_sitemap(guide_changed: bool, home_changed: bool) -> None:
    ...
    paths = ["/", "/mg-windows-toolbox.html", "/mg-linux-toolbox.html", "/donazioni.html", "/guide/"]
    items = []
    for path in paths:
